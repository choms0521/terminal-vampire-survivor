...
```
timestamp,host,emulator,term,colorterm,net,geom,viewport,mode,color_freq,N,target_fps,frames,fps_sustained,bytes_per_frame,frame_ms_p50,frame_ms_p95
```
...
cat bench/results/*.csv | grep -c ',,'   # 0 (빈 셀 없음; 전체 CSV 합산)
```
